    ...
    LinkService linkService) : ControllerBase
{
        ...
        [FromHeader] AcceptHeaderDto acceptHeader) 
    {
        ...
        if (acceptHeader.IncludeLinks)
        {
            ...
            //    Links =
            //    [
            //        linkService.Create(nameof(GetUserProfile), "self", HttpMethod.Get),
            //        linkService.Create(nameof(StoreAccessToken), "store-token", HttpMethod.Put),
            //        linkService.Create(nameof(RevokeAccessToken), "revoke-token", HttpMethod.Delete),
            //    ]
            //};
        }
