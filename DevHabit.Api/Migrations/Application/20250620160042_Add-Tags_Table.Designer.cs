...
namespace DevHabit.Api.Migrations.Application
{
    ...
    [Migration("20250620160042_Add-Tags_Table")]
    partial class AddTags_Table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevHabit.Api.Entites.Habit", b =>
                {
            ...
            modelBuilder.Entity("DevHabit.Api.Entites.Tag", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("DevHabit.Api.Entites.Habit", b =>
                {
                    b.OwnsOne("DevHabit.Api.Entites.Frequency", "Frequency", b1 =>
                        {
                    ...
                    b.OwnsOne("DevHabit.Api.Entites.Milestone", "Milestone", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("DevHabit.Api.Entites.Target", "Target", b1 =>
                        {
                            b1.Property<string>("HabitId")
                                .HasColumnType("character varying(500)")
                                .HasColumnName("id");
